...
import { PointRuleTempViewModel }from './index'

@Table({ tableName: 'pmspointrulemaptemplistview' })

export class PointRuleMapTempListViewModel extends Model{
    ...
    @ForeignKey(() => PointRuleTempViewModel)
    @Column({
        type: DataType.BIGINT
    })
    temp_rule_id: bigint;
