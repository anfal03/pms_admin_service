      ...
      .pipe(
        catchError(err => { 
          ...
          if (err instanceof UnprocessableEntityException) {
            ...
            return throwError(new UnprocessableEntityException(UNPROCESSABLE_ENTITY(error.response?error.response.message:null,error.response.payload?error.response.payload:error.response,req)))
            ...
            return throwError(new BadRequestException(BAD_REQUEST(error.response?error.response.message:null,error.response['error']||null,req)))
